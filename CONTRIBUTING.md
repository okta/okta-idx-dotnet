...
In your browser, navigate to: [https://github.com/okta/okta-idx-dotnet](https://github.com/okta/okta-idx-dotnet)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-idx-dotnet.git
$ cd okta-idx-dotnet
$ git remote add upstream https://github.com/okta/okta-idx-dotnet.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-idx-dotnet](https://github.com/YOUR_ACCOUNT/okta-idx-dotnet)
...
This project and everyone participating in it is governed by the [Okta Code of Conduct](https://github.com/okta/okta-idx-dotnet/tree/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to developers@okta.com.
