...
namespace embedded_sign_in_widget_e2etests.Features
{
    ...
    public partial class SocialLoginWithOktaIdpFeature : object, Xunit.IClassFixture<SocialLoginWithOktaIdpFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "SocialLoginWithOktaIdp.feature"
#line hidden
        
        public SocialLoginWithOktaIdpFeature(SocialLoginWithOktaIdpFeature.FixtureData fixtureData, embedded_sign_in_widget_e2etests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Social Login with Okta Idp", null, ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 5
 testRunner.And("a configured IDP object for Okta Idp", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 6
...
#line hidden
#line 7
 testRunner.And("a user named Mary does not have an account in the org but has an Okta Idp account" +
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                SocialLoginWithOktaIdpFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                SocialLoginWithOktaIdpFeature.FeatureTearDown();
            }
        }
    }
}
